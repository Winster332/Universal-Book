    ...
    public render() {
        return <div>
            ...
            <div className="list-group">
                ...
                <a href="https://www.chromium.org/" className="list-group-item list-group-item-action">
                    <img src="https://upload.wikimedia.org/wikipedia/commons/3/3d/Chromium_11_Logo.png" alt="" height="30"/>
                    <a> Chromium — веб-браузер с открытым исходным кодом, разрабатываемый сообществом The Chromium Authors, компанией Google и некоторыми другими компаниями (Opera Software, Яндекс, NVIDIA, …). По утверждению разработчиков, Chromium предназначен для предоставления пользователям быстрого, безопасного и надёжного доступа в Интернет, а также удобной платформы для веб-приложений.</a>
                </a>
